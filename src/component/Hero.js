...
const Hero = () => {
  return (
    ...
    >
      ...
      <p className="text-[#3cb54e]  animate__animated animate__bounce animate__slow text-sm md:text-[16px] lg:text-[20px] text-center mt-[200px] md:mt-[110px] lg:mt-[180px]">
      ...
      <p className="text-white text-base max-w-[674px] text-center mx-auto">
        Empower your business with forward-thinking solutions while safeguarding
        your digital assets. Let’s innovate securely together
      </p>
